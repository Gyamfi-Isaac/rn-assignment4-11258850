...
const HomeScreen = ({ route }) => {
  ...
  const popularJobs = [
    { key: '1', jobName: 'Jr Executive', salary: '$96,000/y', location: 'Los Angeles, US', backgroundColor: 'white', company: 'Burger King', image: 'https://via.placeholder.com/40' },
    { key: '2', jobName: 'Product Manager', salary: '$84,000/y', location: 'Florida, US', backgroundColor: 'white', company: 'Beats', image: 'https://via.placeholder.com/40' },
    { key: '3', jobName: 'Product Manager', salary: '$86,000/y', location: 'Florida, US', backgroundColor: 'white', company: 'Facebook', image: 'https://via.placeholder.com/40' },
    { key: '4', jobName: 'Marketing Specialist', salary: '$90,000/y', location: 'Seattle, US', backgroundColor: 'white', company: 'Amazon', image: 'https://via.placeholder.com/40' },
    { key: '5', jobName: 'Graphic Designer', salary: '$70,000/y', location: 'Austin, US', backgroundColor: 'white', company: 'Apple', image: 'https://via.placeholder.com/40' },
    { key: '6', jobName: 'Sales Associate', salary: '$65,000/y', location: 'Boston, US', backgroundColor: 'white', company: 'Google', image: 'https://via.placeholder.com/40' },
    { key: '7', jobName: 'HR Manager', salary: '$105,000/y', location: 'Miami, US', backgroundColor: 'white', company: 'Microsoft', image: 'https://via.placeholder.com/40' },
    { key: '8', jobName: 'Operations Manager', salary: '$110,000/y', location: 'Denver, US', backgroundColor: 'white', company: 'Facebook', image: 'https://via.placeholder.com/40' },
  ];
